...
const SignupPage = () => {
  ...
  const { loading, error, isAuthenticated, sessionChecked } = useSelector(
    (state) => state.auth
  );
  ...
  const handleSubmit = async (e) => {
    ...
    const parsedTrainingExperience =
      trainingExperience !== "" ? parseInt(trainingExperience, 10) : undefined;
    ...
    const formData = {
      ...
      ...(parsedTrainingExperience !== undefined && {
        trainingExperience: parsedTrainingExperience,
      }),
    };
  ...
  return (
    <div className="relative min-h-screen w-screen flex flex-col items-center justify-start p-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md pt-20 pb-10">
        <div
          className={`rounded-xl shadow-xl p-8 w-full border-2 transition-colors duration-500
                    ${
                      theme === "dark"
                        ? "bg-gray-900 bg-opacity-75 border-red-700"
                        : "bg-white bg-opacity-75 border-blue-300"
                    }`}
        >
          <h2
        ...
        <div
          className={`mt-10 font-extrabold text-2xl flex items-center justify-center transition-colors duration-500
                    ${theme === "dark" ? "text-blue-500" : "text-blue-700"}`}
        >
