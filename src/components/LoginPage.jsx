    ...
    <div className="relative h-screen w-screen flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          animation: 'gradient 3.55s ease infinite',
        }}
      >
        <style>
          {`
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-md"> 
        ...
        <h1
          className="
            ...
            font-extrabold text-blue-400 text-center mb-12
            overflow-hidden whitespace-nowrap
            font-mono
          "
          style={{
            width: 'fit-content', 
            animation: 'typing 2.5s steps(32) infinite alternate' 
          }}
        >
          Fitness 2099 
        </h1>
        ...
        <div className='mt-10 font-extrabold size-2xl text-blue-500 flex items-center justify-center'>
            <span>
