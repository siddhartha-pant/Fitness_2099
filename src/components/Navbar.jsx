...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <Link to="/" className={`flex items-center text-2xl font-bold font-mono transition-colors duration-300
        ${theme === 'dark' ? 'text-white hover:text-blue-300' : 'text-black hover:text-red-700'}`}>
        Fitness 2099
      </Link>

      {/* Desktop Navigation Links */}
      <div className="hidden md:flex space-x-8 items-center">
        <Link to="/" className={`text-lg font-semibold transition-colors duration-300
          ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-blue-800 hover:text-red-700'}`}>Home</Link>
        <Link to="/about" className={`text-lg font-semibold transition-colors duration-300
          ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-blue-800 hover:text-red-700'}`}>About</Link>
        <Link to="/signin" className={`text-lg font-semibold transition-colors duration-300
          ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-red-700 hover:text-blue-800'}`}>Sign In</Link>
        <Link to="/contact-us" className={`text-lg font-semibold transition-colors duration-300
          ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-blue-800 hover:text-red-700'}`}>Contact Us</Link>
        <Link to="/faq" className={`text-lg font-semibold transition-colors duration-300
          ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-blue-800 hover:text-red-700'}`}>FAQ</Link>
        ...
        >
          ...
          <button
            ...
            className={`block text-xl font-semibold w-full py-2 text-center transition-colors duration-300
              ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-blue-800 hover:text-red-700'}`}
          >
            Home
          </button>
          <button
          ...
          <button
            ...
            className={`block text-xl font-semibold w-full py-2 text-center transition-colors duration-300
              ${theme === 'dark' ? 'text-blue-300 hover:text-blue-100' : 'text-red-700 hover:text-blue-800'}`}
          >
            Sign In
          </button>
          <button
