...
const DashboardPage = () => {
  ...
  if (loadingUser) {
    return (
      <div className="relative min-h-screen w-screen flex items-center justify-center p-4 overflow-hidden"
        ...
        <h2 className={`${textColorPrimary} text-3xl font-bold animate-pulse`}>Loading Dashboard...</h2>
      </div>
    );
  }
  ...
  if (!userData) {
    return (
      <div className="relative min-h-screen w-screen flex flex-col items-center justify-center p-4 overflow-hidden"
           style={{ backgroundImage: backgroundGradient, backgroundSize: '200% 200%', animation: 'gradient 10s ease infinite' }}>
      ...
      <div className={`relative z-10 w-full max-w-6xl mx-auto my-8 p-6 md:p-8 rounded-3xl shadow-2xl backdrop-blur-md
        ...
        <header className="flex flex-col sm:flex-row items-center justify-between pb-6 border-b border-opacity-20
          ...
          <div className="flex flex-col items-center sm:items-start mb-4 sm:mb-0">
            ...
            <p className={`${textColorSecondary} text-lg mt-2 transition-colors duration-500`}>
              Your personalized fitness journey awaits.
            </p>
          </div>

          <div className="flex-shrink-0 relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden shadow-xl border-4
                          transition-colors duration-500
        ...
        <section className="p-6 rounded-xl shadow-lg border transition-colors duration-500
          ...
          {isEditing ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSaveChanges(); }} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Email:</label>
                <input
                  type="email"
                  value={editedEmail}
              ...
              <div>
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Age:</label>
                <input
                  type="number"
                  value={editedAge}
              ...
              <div>
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Gender:</label>
                <select
                  value={editedGender}
              ...
              <div>
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Height (cm):</label>
                <input
                  type="number"
                  step="0.1"
                  value={editedHeight}
              ...
              <div>
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Weight (kg):</label>
                <input
                  type="number"
                  step="0.1"
                  value={editedWeight}
              ...
              <div className="col-span-1 sm:col-span-2">
                <label className={`${textColorSecondary} block text-sm font-bold mb-1`}>Training Experience:</label>
                <select
                  value={editedTrainingExperience}
                  onChange={(e) => setEditedTrainingExperience(e.target.value)}
                  className={`w-full p-2 rounded-md ${inputBgColor} ${inputTextColor} ${inputBorderColor} ${inputFocusRing}`}
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <p className={`${textColorSecondary}`}><strong>Age:</strong> {userData.age}</p>
              <p className={`${textColorSecondary}`}><strong>Gender:</strong> {userData.gender}</p>
              <p className={`${textColorSecondary}`}><strong>Height:</strong> {userData.height} cm</p>
              <p className={`${textColorSecondary}`}><strong>Weight:</strong> {userData.weight} kg</p>
              <p className={`${textColorSecondary}`}><strong>Training Experience:</strong> {userData.trainingExperience}</p>
              <p className={`${textColorSecondary}`}><strong>Member Since:</strong> {userData.joinedDate}</p>
            </div>
          )}
        </section>
